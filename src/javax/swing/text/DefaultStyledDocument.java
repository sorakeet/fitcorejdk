...
public class DefaultStyledDocument extends AbstractDocument implements StyledDocument{
    ...
    public static class AttributeUndoableEdit extends AbstractUndoableEdit{
        ...
        protected AttributeSet copy;        public void redo() throws CannotRedoException{
            super.redo();
    ...
    static class StyleChangeUndoableEdit extends AbstractUndoableEdit{
        ...
        protected Style newStyle;        public void redo() throws CannotRedoException{
            super.redo();
            element.setResolveParent(newStyle);
        }
        protected AttributeSet oldStyle;        public void undo() throws CannotUndoException{
            super.undo();
