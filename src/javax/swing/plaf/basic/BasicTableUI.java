...
//
    ...
    private class Handler implements FocusListener, MouseInputListener,
        ...
        private Component dispatchComponent;        // FocusListener
        ...
        // press event itself
        private int pressedRow;        public void focusGained(FocusEvent e){
            repaintLeadCell();
        }
        private int pressedCol;        public void focusLost(FocusEvent e){
            repaintLeadCell();
        }
        ...
        // it multiple times.
        private boolean outsidePrefSize;        public void mouseClicked(MouseEvent e){
        }
        // Used to delay the start of editing.
        private Timer timer=null;        private void setDispatchComponent(MouseEvent e){
