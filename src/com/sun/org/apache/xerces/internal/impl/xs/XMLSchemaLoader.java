...
// XML Component API
    ...
    } // setFeature(String, boolean)    public void setLocale(Locale locale){
        fLocale=locale;
    ...
    } // getRecognizedProperties():  String[]    public Locale getLocale(){
        return fLocale;
    } // getLocale():  Locale
    ...
    } // getProperty(String):  Object    public void setErrorHandler(XMLErrorHandler errorHandler){
    ...
    } // setProperty(String, Object)    public XMLErrorHandler getErrorHandler(){
    ...
    SchemaGrammar loadSchema(XSDDescription desc,XMLInputSource source,
        ...
        return grammar;
    } // loadSchema(XSDDescription, XMLInputSource):  SchemaGrammar    public XMLEntityResolver getEntityResolver(){
