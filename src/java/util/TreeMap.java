...
public class TreeMap<K,V>
    ...
    private transient NavigableMap<K,V> descendingMap;    public boolean containsKey(Object key){
    ...
    abstract static class NavigableSubMap<K,V> extends AbstractMap<K,V>
        ...
        abstract Iterator<K> keyIterator();        abstract TreeMap.Entry<K,V> subHighest();

        abstract Spliterator<K> keySpliterator();

        abstract Iterator<K> descendingKeyIterator();        abstract TreeMap.Entry<K,V> subCeiling(K key);
